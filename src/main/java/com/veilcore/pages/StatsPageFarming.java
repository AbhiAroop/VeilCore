...
public class StatsPageFarming extends InteractiveCustomUIPage<StatsPageFarming.StatsEventData> {
    ...
    public StatsPageFarming(@Nonnull PlayerRef playerRef, Profile profile) {
    ...
    public void build(
        ...
        cmd.append("Pages/StatsPageFarming.ui");
    ...
    public void handleDataEvent(
        ...
        switch (data.action) {
            ...
            case "Close":
                ...
                break;
            default:
                // Already on Farming page, do nothing
                break;
        }
    }
}
