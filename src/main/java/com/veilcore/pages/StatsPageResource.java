...
public class StatsPageResource extends InteractiveCustomUIPage<StatsPageResource.StatsEventData> {
    ...
    public StatsPageResource(@Nonnull PlayerRef playerRef, Profile profile) {
    ...
    public void build(
        ...
        cmd.append("Pages/StatsPageResource.ui");
    ...
    public void handleDataEvent(
        ...
        switch (data.action) {
            ...
            case "Close":
                ...
                break;
            default:
                // Already on Resource page, do nothing
                break;
        }
    }
}
